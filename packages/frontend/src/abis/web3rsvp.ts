export default [
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'bytes32', name: 'eventID', type: 'bytes32' },
      { indexed: false, internalType: 'address', name: 'attendeeAddress', type: 'address' },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'bytes32', name: 'eventID', type: 'bytes32' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'maxCapacity', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'deposit', type: 'uint256' },
      { indexed: false, internalType: 'string', name: 'eventDataCID', type: 'string' },
    ],
